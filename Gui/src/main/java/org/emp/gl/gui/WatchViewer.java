...
import org.emp.gl.core.lookup.LookupListener;
 ...
 * @author sweeffon
 */
public class WatchViewer extends javax.swing.JFrame implements TimerChangeListener,LookupListener, State {
    ...
    private void initComponents() {
        ...
        sec.setFont(new java.awt.Font("Consolas", 1, 48));
        sec.setText("");
        getContentPane().add(sec, new java.awt.GridBagConstraints());
    ...
    public void propertyChange(PropertyChangeEvent propertyChangeEvent) {
        ...
        if (propertyChangeEvent.getPropertyName().equals(TimerChangeListener.SECONDE_PROP)) {
            if (clilcked){
                sep2.setText(":");
                sec.setText(String.format("%2d", Lookup.getInstance().getService(TimerService.class).getSecondes()));
            }
